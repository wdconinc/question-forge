...
- **Live preview** — automatically renders each question with MathJax math typesetting via Pyodide as you edit
...
2. Click a question in the sidebar to edit its Jinja2 template and Python generator — the preview renders automatically and re-runs as you type
3. Click **▶ Preview** to force a re-run on demand
